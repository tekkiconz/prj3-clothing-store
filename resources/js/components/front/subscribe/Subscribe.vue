    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="content">
                    <h3 class="mt15 mb-3">Get our notification at email</h3>
                </div>
            </div>
            <div class="col-lg-6 col-sm-12">
                <div class="search">
                    <form @submit.prevent="subscribe()">
                        <div class="subs-box">
                            <input name="subscribe" v-model="form.email" class="form-control"
                                   placeholder="Your Email Here" value="" type="text">
