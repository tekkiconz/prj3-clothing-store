<template>
    <div class="container">
        ...
        <div class="row offers">
            ...
            <div class="col-6 col-lg-3 col-sm-6" v-for="(value,index) in categoryProducts" :key="index">
...
export default {
    ...
    methods: {
        fetchProduct: function () {
            ...
            return axios.get(base_url + 'category-product-list/' + this.category_id + '?page=' + this.page);
        },
