                        ...
                        <div class="col-md-12 text-center">
                            <div class="form-group">
                                <p><strong> Sub Total : </strong> {{
                                        currency.symbol
                                    }}{{ order.total_amount | formatPrice }}</p>
                                <p><strong> Shipping : </strong> {{
                                        currency.symbol
                                    }}{{ order.shipping_amount | formatPrice }}</p>
                                <p><strong> Total :</strong> {{
                                        currency.symbol
                                    }}{{ order.total_amount + order.shipping_amount | formatPrice }}
                                </p>
                            </div>
                            <div class="form-group" v-for="value in payment_methods" :key="value.id">
                                <div class="row" v-if="value.id == 3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control mt-2" v-model="stripe.card_no"
                                               placeholder="Card No">
                                        <input type="text" class="form-control mt-2" v-model="stripe.cvc"
