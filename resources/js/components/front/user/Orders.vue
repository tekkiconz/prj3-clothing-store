                        ...
                        <tbody>
                            <tr v-for="order in orders.data" :key="order.id">
                                ...
                                <td>
                                    ...
                                    <span v-if="order.status == 3">Delivered</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="#" @click.prevent="viewDetails(order)"
                                       class="button button-xs bg-dark2 color-white ">Details</a>
                                    <a :href="url+'user-order-details-pdf/'+order.id"
                                       class="btn btn-primary float-center btn-sm" title="Download Pdf"><i
