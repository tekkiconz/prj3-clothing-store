        ...
        <div class="col-lg-12">
            ...
            <div class="ibox animated fadeInRightBig">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a :href="url+'admin/export?req=invoice&range='+this.rangeDate+'&city='+this.city.id"
                           class="btn btn-success btn-sm"><i class="fa fa-file-excel-o" aria-hidden="true"></i>
                            Excel</a>
                        <a :href="url+'admin/product-invoice-report-pdf?range='+this.rangeDate+'&city='+this.city.id"
                           class="btn btn-primary btn-sm"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>

                        <a :href="url+'admin/product-invoice-report-print?range='+this.rangeDate+'&city='+this.city.id"
...
export default {
    ...
    methods: {
        getProduct(page = 1) {
            ...
            axios.get(base_url + 'admin/product-invoice-report?range=' + this.rangeDate + '&city=' + this.city.id
            )
                .then(response => {
