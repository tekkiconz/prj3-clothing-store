    ...
    <div class="row">
        <div class="col-lg-12">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="value in products.data" :key="value.id">
                                            ...
                                            <td>{{ value.total_buying_amount | formatPrice }}</td>
                                            <td>{{ value.total_sales_amount | formatPrice }}</td>
                                            <td>{{ value.total_sales_amount - value.total_buying_amount | formatPrice }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="ibox animated fadeInRightBig">
                <div class="row">
                    <div class="col-md-9">
                        <pagination v-if="products.data" :pageData="products.data"></pagination>
                    </div>
                    <div class="col-md-3">
                        <a :href="url+'admin/export?req=sales&category='+this.category.id + '&sub_category='+this.sub_category.id+'&sub_sub_category='+this.sub_sub_category.id+'&brand='+this.brand.id+'&range='+this.rangeDate"
                           class="btn btn-success btn-sm"><i class="fa fa-file-excel-o" aria-hidden="true"></i>
                            Excel</a>
                        <a :href="url+'admin/product-sales-report-pdf?category='+this.category.id + '&sub_category='+this.sub_category.id+'&sub_sub_category='+this.sub_sub_category.id+'&brand='+this.brand.id+'&range='+this.rangeDate"
                           class="btn btn-primary btn-sm"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>

                        <a :href="url+'admin/product-sales-report-print?category='+this.category.id + '&sub_category='+this.sub_category.id+'&sub_sub_category='+this.sub_sub_category.id+'&brand='+this.brand.id+'&range='+this.rangeDate"
