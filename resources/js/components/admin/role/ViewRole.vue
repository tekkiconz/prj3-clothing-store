                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(value,index) in roles.data" :key="index">
                                    ...
                                    <td><a @click.prevent="perMission(value.id)" href=""
                                           class="btn btn-secondary rounded"><i class="fa fa-key"></i></a></td>
                                    <td>
                                        <a @click.prevent="edit(value)" class="btn btn-primary" href="#"><i
                                            class="fa fa-edit" title="Edit"></i></a>
                                        <a @click.prevent="deleterole(value.id)" class="btn btn-danger" href="#"><i
