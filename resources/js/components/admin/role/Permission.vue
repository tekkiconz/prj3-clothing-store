        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h3 class="m-t-none m-b">Assinging Permission To <strong class="text-primary">{{
                            role.role_name
                        }}</strong></h3>
                </div>
                        ...
                        <form @submit.prevent="AssignRole()" role="form">
                            ...
                            <div class="row" v-for="(value,index) in role.menus" :key="index">
                                ...
                                <div class="col-md-3" v-for="sub in value.sub_menu">
                                    ...
                                    <div class="switch">
                                        <div class="onoffswitch">
                                            <input :value="sub.id" :id="sub.id" v-model="sub.check" type="checkbox"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button style="margin-top: 20px;" class="btn btn-lg  btn-primary float-right "
