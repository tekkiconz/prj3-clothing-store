                    ...
                    <div class="row">
                        <div class="col-sm-8 b-r"><h3 class="m-t-none m-b">Add Admin</h3>
                            <form @submit.prevent="save()" role="form">
                                <div class="form-group">
                                    ...
                                    <input v-model="admin.name" type="text" placeholder="Admin Name"
                                           class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input v-model="admin.email" type="text" placeholder="Admin Email"
                                           class="form-control">
                                </div>


                                <div class="form-group">
                                    <label>Admin Icon *</label> <br>
                        ...
                        <div class="col-sm-4"><h4>Photo Preview</h4>
                            ...
                            <p class="text-center" v-else>
                                <cld-image v-if="admin.view_image" :publicId="admin.view_image"
                                           loading="lazy"
                                           height="100"
