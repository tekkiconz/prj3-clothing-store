                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(value,index) in admins.data" :key="index">
                                    <td>
                                        <cld-image v-if="value.avatar" :publicId="value.avatar" loading="lazy">
                                            <cld-transformation radius="max" />
                                            <cld-transformation height="100" crop="scale" />
                                        </cld-image>
                                        <img v-else v-lazy="url+'/images/default_avatar.png'" class="rounded-circle"
                                    ...
                                    <td>
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input @change="changeStatus(value.id)" type="checkbox"
                                                       :checked="value.status" class="onoffswitch-checkbox"
                                                       :id="value.id">
                                    ...
                                    <td>
                                        <a @click.prevent="edit(value.id)" class="btn btn-primary" href="#"><i
                                            class="fa fa-edit" title="Edit"></i></a>
                                        <a @click.prevent="deleteadmin(value.id)" class="btn btn-danger" href="#"><i
