                        ...
                        <div class="col-sm-8 b-r"><h3 class="m-t-none m-b">Create Admin</h3>
                            <form @submit.prevent="save()" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="admin.password_confirmation" type="password"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="area" class="form-control" v-model="admin.area">
                                        ...
                                        <option v-for="value in cities" :key="value.id" :value="value.id">{{
                                                value.city
                                            }}
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
									...
									<span class="btn btn-block btn-primary btn-file"><span class="fileinput-new"><i
                                        class="fa fa-camera"></i> Choose Avatar</span>
									<span class="fileinput-exists">Change Avatar</span><input type="file" name="..."
