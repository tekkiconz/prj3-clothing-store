    ...
    <div class="row">
            ...
            <form @submit.prevent="save()" role="form">
                ...
                <div class="form-group">
                    <label>Theme Color (<span
                        class="text-danger">Remember your color will combination with white text</span>)</label>
                    <input type="text" v-model="form.theme_color" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <span class="btn btn-block btn-primary btn-file"><span class="fileinput-new"><i
                        class="fa fa-camera"></i> header logo</span>
                    <span class="fileinput-exists">header logo</span><input type="file" name="..."
                                                                            @change="onHeaderImageChange"/></span>
                    </div>

                    <div class="fileinput fileinput-new" data-provides="fileinput">
                    <span class="btn btn-block btn-primary btn-file"><span class="fileinput-new"><i
                        class="fa fa-camera"></i> footer logo</span>
                    <span class="fileinput-exists">footer logo</span><input type="file" name="..."
                                                                            @change="onFooterImageChange"/></span>
                    </div>


                    <div class="fileinput fileinput-new" data-provides="fileinput">
                    <span class="btn btn-block btn-primary btn-file"><span class="fileinput-new"><i
                        class="fa fa-camera"></i> Favicon</span>
                    <span class="fileinput-exists">Favicon</span><input type="file" name="..."
                                                                        @change="onFaviconChange"/></span>
                    </div>
                ...
                <div style="margin-bottom: 20px;">
                    <button style="margin-bottom: 20px;" class="btn btn-lg  btn-primary float-right " type="submit">
        ...
        <div class="col-sm-4">
            ...
            <p class="text-center" v-else :style="themBg">
                <cld-image :publicId="form.header_logo_view" loading="lazy"
                           class="img-responsive img-fluid"></cld-image>
            </p>
            ...
            <p class="text-center" v-else>
                <cld-image :publicId="form.footer_logo_view" loading="lazy"
                           class="img-responsive img-fluid"></cld-image>
            </p>
            ...
            <p class="text-center" v-else>
                <cld-image :publicId="form.favicon_view" loading="lazy"
                           class="img-responsive img-fluid"></cld-image>
            </p>
        </div>

        <div class="col-md-12" v-if="validation_error" style="margin-top: 20px;margin-bottom: 20px;">
            <div class="form-group">
                <div>
                    <ul>
...
export default {
    ...
    methods: {
        ...
        getSetting() {
            ...
            axios.get(base_url + 'admin/setting/shop/' + 1 + '/edit')
                .then(response => {
        ...
        save() {
            ...
            axios.post(base_url + 'admin/setting/shop', this.form)
                .then(response => {
