        ...
        <div class="col-md-5 border p-4 mx-auto"><h3 class="m-t-none m-b">Update Setting</h3>
            <form @submit.prevent="save()" role="form">
                ...
                <div class="form-group">
                    ...
                    <!-- <input v-model="form.encryption" type="text" class="form-control"> -->
                </div>
                <div class="form-group">
                    <label>Mailing</label>
                    <div class="switch">
                        <div class="onoffswitch">
                            <input type="checkbox" :checked="form.status == 1 ? true : false"
                                   class="onoffswitch-checkbox" id="example2" @change="mailStatus()">
        ...
        <div class="col-md-5 mx-auto">
            <div class="card">
                <div class="card-header">
                    <div class="card-title"><h3>Instruction</h3></div>
                </div>
                <div class="card-body">
                    <ul>
                        <li>Make sure you select IMAP server to send email. The mailing driver you'd like to use. By
                            default, this is set to SMTP, but you can also change it to use PHPs mail feature or
                            Sendmail instead.
                        </li>

                        <li>Enter your SMTP server's host address.</li>

                        <li>Under user information, enter a name and the current email address in which you would like
                            to set up.
                        </li>

                        <li>Enter your email address into the username field and your password that you have been
                            sent.
                        </li>
                        ...
                        <li>Turning on 'less secure apps' settings as mailbox user
                            <ul>
                                ...
                                <li>On the bottom of the page, in the Less secure app access panel, click Turn on
                                    access.
                                </li>
                                <li>If you don't see this setting, your administrator might have turned off less secure
                                    app account access (check the instruction above).
                                </li>
