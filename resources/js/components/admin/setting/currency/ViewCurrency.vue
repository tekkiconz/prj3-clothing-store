                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(value,index) in currencies.data" :key="index">
                                    ...
                                    <td>{{ value.symbol }}</td>
                                    <td>
                                        <a v-if="value.currency_status == 0" @click.prevent="makeCurrent(value.id)"
                                           class="btn btn-success" href="#">Set as Your Currency</a>
                                    ...
                                    <td>
                                        ...
                                        <a @click.prevent="deletecurrency(value.id)" class="btn btn-danger" href="#"><i
