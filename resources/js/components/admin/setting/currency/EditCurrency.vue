                        ...
                        <div class="col-sm-8 mr-auto ml-auto"><h3 class="m-t-none m-b">Edit Currency</h3>
                            <form @submit.prevent="save()" role="form">
                                <div class="form-group">
                                    ...
                                    <input v-model="currency.country" type="text" placeholder="Country Name"
                                           class="form-control">
                                </div>

                                <div class="form-group">
                                    <label>Currency Name *</label>
                                    <input v-model="currency.currency" type="text" placeholder="Currency Name"
                                           class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Code</label>
                                    <input v-model="currency.code" type="text" placeholder="ex : USD"
                                           class="form-control">
                                </div>

                                <div class="form-group">
                                    <label>Symbol</label>
                                    <input v-model="currency.symbol" type="text" placeholder="ex : $"
                                           class="form-control">
                                </div>
