        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-8 mr-auto ml-auto"><h3 class="m-t-none m-b">Update {{ social.provider }}
                            Login Credential</h3>
                            <form @submit.prevent="save()" role="form">
                                <div class="form-group">
                                    <label>Provider Name *</label>
                                    <input v-model="social.provider" type="text" placeholder="Provider Name" disabled=""
                                           class="form-control">
                                </div>

                                <div class="form-group">
                                    <label>Client Id / app_id *</label>
                                    <input v-model="social.app_id" type="text" placeholder="App Key"
                                           class="form-control">
                                </div>

                                <div class="form-group">
                                    <label>Secret *</label>
                                    <input v-model="social.app_secret" type="text" placeholder="App Secret"
                                           class="form-control">
                                </div>
