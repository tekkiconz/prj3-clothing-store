                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="value in pagesData.data" :key="value.id">
                                    ...
                                    <td>
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" :checked="value.publish == 1 ? true : false"
                                    ...
                                    <td>
                                        <a @click.prevent="showData(value)" class="btn btn-success" href="#"><i
                                            class="fa fa-book" title="View"></i></a>
                                        <a @click.prevent="edit(value)" class="btn btn-primary" href="#"><i
                                            class="fa fa-edit" title="Edit"></i></a>
                                        <a @click.prevent="deletePage(value.id)" class="btn btn-danger" href="#"><i
