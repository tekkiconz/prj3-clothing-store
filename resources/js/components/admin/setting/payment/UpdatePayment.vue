                        ...
                        <div class="col-sm-8 mr-auto ml-auto"><h3 class="m-t-none m-b">Edit payment</h3>
                            <form @submit.prevent="save()" role="form">
                                <div class="form-group">
                                    ...
                                    <input v-model="payment.provider" type="text" placeholder="Provider Name"
                                           disabled="" class="form-control">
                                </div>

                                <div class="form-group">
                                    <label>Client Id / Key *</label>
                                    <input v-model="payment.client_id" type="text" placeholder="Client Key"
                                           class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Secret *</label>
                                    <input v-model="payment.client_secret" type="text" placeholder="Client Secret"
                                           class="form-control">
                                </div>
