    ...
    <div class="row">
        <div class="col-sm-8 b-r"><h3 class="m-t-none m-b">Update Setting</h3>
            <form @submit.prevent="save()" role="form">
                ...
                <div class="form-group">
                    <label>Keyword</label>
                    <multiselect v-model="form.seo_keyword" tag-placeholder="Add this as new tag"
                                 placeholder="Search or add a tag" label="keyword" track-by="id" :options="tags"
                ...
                <div class="form-group">
                    ...
                    <span class="btn btn-block btn-primary btn-file"><span class="fileinput-new"><i
                        class="fa fa-camera"></i> Change Image</span>
        ...
        <div class="col-sm-4"><h4>Seo Image Preview</h4>
            ...
            <p class="text-center" v-else>
                <cld-image :publicId="form.view_image" loading="lazy" class="img-responsive img-fluid"></cld-image>
            </p>
