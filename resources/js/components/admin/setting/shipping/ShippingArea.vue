                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input placeholder="Search By City" v-model="keyword" type="text"
                                       class="form-control form-control-sm" @keyup="getOrderArea()">
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="value in areas.data" :key="value.id">
                                    ...
                                    <td>
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" :checked="value.status == 1 ? true : false"
                                                       class="onoffswitch-checkbox" :id="value.id"
                                                       @change="changeStatus(value.id)">
                                    ...
                                    <td>
                                        <a @click.prevent="edit(value)" class="btn btn-primary" href="#"><i
                                            class="fa fa-edit" title="Edit"></i></a>
                                        <a @click.prevent="deletearea(value)" class="btn btn-danger" href="#"><i
