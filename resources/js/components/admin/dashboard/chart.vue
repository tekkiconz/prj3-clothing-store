                ...
                <div class="ibox animated fadeInRightBig">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            ...
                            <select class="form-control-sm form-control input-s-sm inline" v-model="status1">
                        ...
                        <line-chart v-if="status1 === 'category'"></line-chart>
                        <order-chart v-if="status1 === 'order'"></order-chart>
                        <sale-chart v-if="status1 === 'sale'"></sale-chart>
                        <customer-chart v-if="status1 === 'customer'"></customer-chart>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="ibox animated fadeInRightBig">
                    ...
                    <div class="ibox-content">
                       ...
                       <div class="row">
                           <div class="col-sm-5 m-b-xs">
                           <select class="form-control-sm form-control input-s-sm inline" v-model="status2">
                               <option :value="'category'">Category wise Product Stock</option>
                               <option :value="'order'">Current Month Order</option>
                               <option :value="'sale'">Current Month Sale</option>
                               <option :value="'customer'">Current Month Add Customer</option>
                       ...
                       -->
                        ...
                        <line-chart v-if="status2 === 'category'"></line-chart>
                        <order-chart v-if="status2 === 'order'"></order-chart>
                        <sale-chart v-if="status2 === 'sale'"></sale-chart>
                        <customer-chart v-if="status2 === 'customer'"></customer-chart>
                    </div>
                </div>
            </div>
