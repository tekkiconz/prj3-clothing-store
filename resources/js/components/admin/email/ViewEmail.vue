            ...
            <div class="mail-box">
                <div class="mail-body">
                    <div class="form-group row"><label class="col-sm-2 col-form-label">To:</label>
                        <div class="col-sm-8">
                            <multiselect v-model="users.selected_email" tag-placeholder="Add this as new email"
                                         placeholder="Chose or write email" label="email" track-by="id"
                                         :options="emails" :multiple="true" :taggable="true"
                                         @tag="addTag"></multiselect>
                        </div>
                        <div class="col-sm-2 m-auto">
                            <label> <input type="checkbox" v-model="users.all_user" class="icheckbox_square-green"
                                           @change="loadUser()"> All User </label>
                        </div>
                    </div>
                    <div class="form-group row"><label class="col-sm-2 col-form-label">To:</label>
                        <div class="col-sm-8">
                            <multiselect v-model="users.selected_subscriber" tag-placeholder="Add this as new email"
                                         placeholder="Chose or write email" label="email" track-by="id"
                                         :options="subscriber_email" :multiple="true" :taggable="true"
                                         @tag="addTag"></multiselect>
                        </div>
                        <div class="col-sm-2 m-auto">
                            <label> <input type="checkbox" v-model="users.all_subscriber" class="icheckbox_square-green"
                                           @change="loadSubscriber()"> All Subscriber </label>
                        </div>
                    </div>
