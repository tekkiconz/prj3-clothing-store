                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(value,index) in customers.data" :key="index">
                                    ...
                                    <td>
                                        <a @click.prevent="viewOrder(value.id,value.name)" class="btn btn-primary"
                                           href="#"><i class="fa fa-eye" title="View Orders"></i></a>
                                    </td>
                                    <td>
                                        <a @click.prevent="changeCustomerStatus(value.id)" class="btn btn-danger" href="#">
                                            <span v-if="value.status == 1"><i class="fa fa-ban" title="Deactivate"></i></span>
                                            <span v-else><i class="fa fa-unlock" title="Activate"></i></span>
                                        </a>
                                    </td>
                                </tr>
    ...
    methods: {
        ...
        changeCustomerStatus(id) {
            Swal.fire({
                ...
                if (result.value) {
                    axios.get(base_url + 'admin/customer/status/' + id)
                        .then(res => {
