                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(value,index) in orders.data" :key="index">
                                    ...
                                    <td>
                                        <a @click.prevent="getDetails(value.id)" class="btn btn-primary" href="#"><i
                                            class="fa fa-eye" title="View Details"></i></a>
                                        <a @click.prevent="deleteorder(value.id)" class="btn btn-danger" href="#"><i
