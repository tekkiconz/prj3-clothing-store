                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="(value,index) in campaigns.data" :key="index">
                                    ...
                                    <td>
                                        <cld-image :publicId="value.banner"
                                                   loading="lazy" height="100"></cld-image>
                                    </td>
                                    <td>
                                        <cld-image v-if="value.meta_image" :publicId="value.meta_image"
                                                   loading="lazy" height="100"></cld-image>
                                    </td>
                                    <td>
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input @change="campaignStatus(value.id)" type="checkbox"
                                    ...
                                    <td>
                                        ...
                                        <a @click.prevent="deletecampaign(value.id)" class="btn btn-danger" href="#"><i
