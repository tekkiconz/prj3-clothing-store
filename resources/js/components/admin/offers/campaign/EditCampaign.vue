            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form @submit.prevent="save()">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" v-model="form.campaign_title" class="form-control"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <img style="height: 80px;max-width: 150px" v-if="form.banner" :src="form.banner">

                                        <cld-image v-else :publicId="form.view_banner"
                                                   loading="lazy" height="80" style="max-width: 150px"></cld-image>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
										<span class="btn btn-block btn-primary btn-file"><span class="fileinput-new"><i
                                            class="fa fa-camera"></i> Choose Image</span>
										<span class="fileinput-exists">Change Image</span><input type="file" name="..."
                                                                                                 @change="onMetaImageChange"/></span>

                                        <img style="height: 80px;max-width: 150px" v-if="form.meta_image" :src="form.meta_image">

                                        <cld-image v-else :publicId="form.view_meta_image"
                                                   loading="lazy" height="80" style="max-width: 150px"></cld-image>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <multiselect v-model="form.product" id="ajax" label="product_name" track-by="id"
                                             placeholder="Search for Product" open-direction="bottom"
                                             :options="products" :multiple="true" :searchable="true"
                                             :loading="isLoading" :internal-search="false" :clear-on-select="false"
                                             :close-on-select="false" :options-limit="300" :limit="15"
                                             :limit-text="limitText" :max-height="600" :show-no-results="false"
                                    ...
                                    <table class="table table-border table-condensed table-strip">
                                        ...
                                        <tbody>
                                            <tr v-for="(value,index) in form.product" :key="index">
                                                <td>
                                                    <cld-image :publicId="value.feature_image"
                                                               loading="lazy" height="60"></cld-image>
                                                </td>
                                                <td>{{ value.product_name }}</td>
                                                <td>{{ value.selling_price }}</td>
                                                <td>
                                                    <input v-model="value.discount" class="form-control" type="number"
                                                           name="">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="hidden"
                                                           :value="value.discount_amount = discount(value.discount_type,value.discount,value.selling_price)">
