<template>
    <div class="row">
        <div class="col-lg-12">
                            ...
                            <div class="ibox">
                                <div class="ibox-content product-box">
                                    ...
                                    <div class="product-imitation">
                                        <cld-image :publicId="value.feature_image" loading="lazy" class="img-fluid">
                                        </cld-image>
                                    </div>
                                    <div class="product-desc">
                                        <span style="left: 0 !important" class="product-price">
                                            Qty {{ value.current_quantity }}
                                        </span>
                                        <span class="product-price">
                                            Price :

                                            <span v-if="value.discount_status == 1 && value.discount_amount > 0"
                                                  class="cut-text">
                                        ...
                                        <small class="text-muted">{{ value.sub_sub_category.sub_sub_category_name }}
                                            -></small>
                                         ...
                                         <span>Hot Deal
                                          <div class="switch">
                                            <div class="onoffswitch">
                                                <input @change="hotDeal(value.id)" type="checkbox"
                                                       :checked="value.hot_deal == 1 ? true : false "
                                                       class="onoffswitch-checkbox" :id="value.id">
                                        ...
                                        <div class="m-t text-righ">
                                            <a @click.prevent="Deactive(value.id,value.status)" href=""
                                               class="btn btn-sm btn-outline btn-primary"
                                               title="Make Active Or Deactive">

                                                <span v-if="value.status == 1"><i
                                                    class="fa fa-check"></i> Deactivate</span>
                                                <span v-else><i class="fa fa-check"></i> Activate</span>
                                            </a>
                                            <a @click.prevent="getdiscount(value.id)" href=""
                                               class="btn btn-sm btn-outline btn-info"><i class="fa fa-fire"></i>
                                                Discount</a>
                                            <a @click.prevent="edit(value.id)" href="" title="Edit Product"
                                               class="btn btn-sm btn-outline btn-warning"><i class="fa fa-edit"></i></a>
                                            <a @click.prevent="deleteProduct(value.id)" title="Delete Product" href="#"
                                               class="btn btn-sm btn-outline btn-danger"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="ibox">
                <update-product :categories="categories"></update-product>
            </div>
            <div class="ibox">
