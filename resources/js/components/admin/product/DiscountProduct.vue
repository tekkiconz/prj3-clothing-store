                                ...
                                <div class="table-responsive">
                                    <table class="table table-border table-condensed table-strip">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <cld-image :publicId="feature_image" loading="lazy" height="60"></cld-image>
                                                </td>
                                                <td>{{ product_name }}</td>
                                                <td>{{ selling_price }}</td>
                                                <td>
                                                    <input v-model="discform.discount" class="form-control"
                                                           type="number" name="">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="hidden"
                                                           :value="discform.discount_amount = discount(discform.discount_type,discform.discount,selling_price)">
