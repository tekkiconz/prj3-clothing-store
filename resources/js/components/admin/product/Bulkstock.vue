                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form @submit.prevent="uploadExcel()" role="form">
                                <div class="form-group">
                                    <p>Download format and product list by filtering in <a
                                        :href="url+'admin/stock-report'">stock list report </a> <br> you will find a
                                        button download sample product list</p> <br>
                                    <span class="btn btn-primary btn-file"><span class="fileinput-new"
                                                                                 id="excel-file"><i
                                        class="fa fa-file-excel-o"></i> Choose Excel</span>
                                ...
                                <button type="submit" class="btn btn-info"><i class="fa fa-upload"
                                                                              aria-hidden="true"></i> {{ button_name }}
                                </button>
                            </form>
                        </div>
                    </div>
