            ...
            <table>
                ...
                <tbody><?php $i = 1; ?>
                    @foreach($orderdetails as $value)
                        <tr>
                            ...
                            <td>{{ $value->selling_price }}
                                @if($value->unit_discount > 0)<sub>
                                    <del><small>{{ $value->selling_price + $value->unit_discount }}</small></del>
                                </sub>@endif
                            </td>
                    ...
                    <tr>
                        ...
                        <td class="grand total">{{ getCurrentCurrency()->code }} {{ $order->total_amount + $order->shipping_amount }}</td>
                    </tr>
                </tbody>
            </table>
        </main>
