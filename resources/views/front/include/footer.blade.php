<footer>
    <div class="container">
        <div class="row footer-primary clearfix   mb20 ">
            <div class="col-lg-3 col-sm-6 xs-mb30">
                <div class="logo">
                    <a href="{{ url('/') }}">
                        <x-cld-image public-id="{{ $shop_info->logo_footer }}" loading="lazy"
                                     alt="logo" class="img-fluid"></x-cld-image>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 xs-mb30">
                <div class="footer-menu">
                    <h4>Quick Links</h4>
                    <ul>
                        <!-- it's coming from helpers  in app/helpers/helpers -->
                        @if(count(allPages()) > 0)
                            @foreach(allPages() as $value)
                                <li><a href="{{ url('page',str_replace(' ','-',$value->title))}}"><i
                                            class='lni lni-chevron-right'></i> {{ $value->title }}</a></li>
                            @endforeach
                        @endif
                    </ul>
                </div>
            ...
            <div class="col-lg-3 col-sm-6 xs-mb30">
                <div class="footer-menu">
                    ...
                    <ul>
                        @auth
                            <li><a href="{{ route('user.profile') }}"><i class='lni lni-chevron-right'></i> Profile</a>
                            </li>
                            <li><a href="{{ route('user.order') }}"><i class='lni lni-chevron-right'></i> My Order</a>
                            </li>
                            <li><a href="{{ route('user.logout') }}"><i class='lni lni-chevron-right'></i> Logout</a>
                            </li>
                        @endauth
                        @guest
                        ...
                        @endguest
                        <li><a href="{{ route('order.track') }}"><i class='lni lni-chevron-right'></i> Track Your Order</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="footer-secondary">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12 xs-mb30 pl-0">
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12 px-0">
