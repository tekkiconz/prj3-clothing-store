...
@section('meta')
    ...
    <meta property="og:url"
          content="{{  url('/').'offer/'.$campaign->id.'/'.str_replace('%','-percent',str_replace(' ', '-', $campaign->title)) }}"/>
    <meta property="og:image" content="{{ 'https://res.cloudinary.com/ditgrfuov/image/upload/'.$campaign->meta_image.'.jpg' }}"/>
