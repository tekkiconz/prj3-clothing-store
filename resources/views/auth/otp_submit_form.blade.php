                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="form bg-white bg-shadow">
                                <div class="heading text-center clearfix">
                                    <h4 class="pt10 color-dark login-headline">OTP Confirm</h4>
                                    <small class="heading  center-block heading-width-100 border-light  mb-10">Please
                                        provide the otp code which we sent on your phone number within 5
                                        minutes</small>
                                </div>
                                <div class="p30">
                                    <form method="POST" action="{{ route('submit.otp') }}">
                                        ...
                                        <button type="submit"
                                                ...
                                                style="width: 100%">Submit OTP & Login
                                        </button>
                                    ...
                                    <form method="POST" action="{{ route('send.otp') }}">
                                        ...
                                        <button type="submit" class="btn btn-link text-center">Din't get code ? Click
                                            here to Resend Code
                                        </button>
