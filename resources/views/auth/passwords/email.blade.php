                                ...
                                <div class="p30">
                                    ...
                                    <form method="POST" action="{{ route('user-password-email-reset-link') }}">
                                        ...
                                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <input class="sign-up-input form-control" name="email" placeholder="Email"
                                        ...
                                        <button type="submit"
                                                ...
                                                style="width: 100%">Submit & check your email inbox
                                        </button>
                                    </form>
                                    <div class="account-info clearfix width-res">
                                        <h5 class="color-dark">
                                            <a class="float-l te-und-ho" href="{{ route('login') }}">Login</a>
                                            <a href="{{ route('register') }}" class=" float-r te-und-ho">Create
                                                Account</a>
                                        </h5>
                                    </div>
                                </div>
