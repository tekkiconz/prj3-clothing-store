...
<html>
    <head>
        ...
        <link rel="shortcut icon"
              href="{{ 'https://res.cloudinary.com/ditgrfuov/image/upload/'.$shop_info->favicon.'.jpg' }}"/>
            ...
            <div class="col-md-4 mr-auto ml-auto">
                <div class="middle-box text-center loginscreen animated fadeInDown" style="padding-top: 0 !important">
                    <div>
                        <div>
                            <a href="{{ url('/') }}">
                                <x-cld-image public-id="{{ $shop_info->logo_footer }}"
                                             loading="lazy" style="margin: 20px 0px;"></x-cld-image>
                            </a>
                        </div>
