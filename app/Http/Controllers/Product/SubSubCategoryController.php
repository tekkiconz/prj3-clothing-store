    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($imageData) {
                ...
                $savedImageId = cloudinary()->upload($imageData, ['folder' => 'clothes-store/sub_sub_category/icon'])->getPublicId();

                $sub_sub_category->icon = $savedImageId;
        ...
        try {
            ...
            if ($imageData) {
                ...
                if (!empty($sub_category->icon)) {
                    cloudinary()->destroy($sub_category->icon);
                }

                $savedImageId = cloudinary()->upload($imageData, ['folder' => 'clothes-store/sub_sub_category/icon'])->getPublicId();

                $sub_category->icon = $savedImageId;
