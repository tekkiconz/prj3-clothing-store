...
// getting current currency
        ...
        $post_data['total_amount'] = $order->total_amount + $order->shipping_amount;
...
# CART PARAMETERS
        ...
        $post_data['product_amount'] = $order->total_amount + $order->shipping_amount;
        $post_data['vat'] = "5";
...
# PARSE THE JSON RESPONSE
    ...
    public function sslCommerzCancel(Request $request)
    {
        ...
        return redirect()->route('order.completed', [
            ...
            'flug' => 1,
            'status' => 'error',
            'message' => 'The payment has been canceled for order #' . $request->tran_id . '.but order taken as
            cash on delivery if u wants to pay click on My Order button',
        ]);
